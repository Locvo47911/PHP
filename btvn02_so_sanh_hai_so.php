...
<html lang="">
	...
	<body>
		<form action="" method="POST" role="form">
			...
			<div class="form-group">
				<input type="text" class="form-control" name="b" placeholder="Nhập vào b: " required="require">
			</div>
	 		...
	 		<h2>
	 			<?php 
					...
					if(!empty($a) && !empty($b) && is_numeric($a) && is_numeric($b))
					{
						if($a > $b)
						{
							echo "$a là số lớn nhất.</br></br>";		
							echo "$b là số nhỏ nhất.";
						}
						elseif($b > $a)
						{
							echo "$b là số lớn nhất.</br></br>";
							echo "$a là số nhỏ nhất.</br></br>";
						}	 
					}
					else 
					{
						 echo "Nhập vào giá trị để so sánh !";
					}
	 			?>	
	 		</h2>
		</form>
